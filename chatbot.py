...
st.set_page_config(page_title="Gemini LLM Chatbot", page_icon=":robot_face:")

# Streamlit Header and Subheader
st.markdown("<h1 style='text-align: center; color: #2E8B57;'>Gemini LLM Chatbot</h1>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center; color: #708090;'>Chat with the Gemini LLM</h4>", unsafe_allow_html=True)
...
# Footer
st.markdown("<div style='text-align: center; color: #808080; margin-top: 20px;'>Developed by Somani with Skill Cred</div>", unsafe_allow_html=True)
